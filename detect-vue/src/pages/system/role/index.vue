            ...
            <Modal :title="selectIndex < 0 ? $t('page.common.add') : $t('page.common.modify')"
                ...
                <Form ref="formValidate" :model="entity" :label-width="100" :rules="ruleValidate">
                    ...
                    <FormItem :label="$t('page.role.entityDescription') + $t('page.role.access')" prop="access">
                        <Input v-model="entity.access" :placeholder="$t('page.role.entityDescription') + $t('page.role.access')"></Input>
                    </FormItem>
                </Form>
        ...
        data() {
            return {
                ...
                ruleValidate: {
                    ...
                    access: [
                        {required: true, message: format($t('page.common.notNullTemplate'), {propertyName: $t('page.role.entityDescription') + $t('page.role.access') }), trigger: 'blur'}
                    ]
                }
            }
        },
