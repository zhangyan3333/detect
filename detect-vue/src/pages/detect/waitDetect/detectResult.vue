<template xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
	...
	>
		...
		<div class="divList" >
			...
			<Input class="pInput" style="font-size: 25px;width: 30%" v-model="startDate"/>
		</div>
		...
		<div style="width: 80%;margin-left: 10%;margin-top: 20px">
			...
			<Row style="height: 200px">
				...
				<Col span="4" class="ivu-b ivu-text-center">
					...
					<Row style="height: 100px">
						<Col span="24" class="ivu-b ivu-text-center"><p style="margin-top: 10%;font-size: 20px">0.05级数字压力计标准装置</p></Col>
					</Row>
				</Col>
				<Col span="4" class="ivu-b ivu-text-center">
					<Row style="height: 100px">
					...
					<Row style="height: 100px">
						<Col span="24" class="ivu-b ivu-text-center"><p style="margin-top: 20%;font-size: 20px">(0～60)MPa</p></Col>
					</Row>
				</Col>
				<Col span="4" class="ivu-b ivu-text-center">
					<Row style="height: 100px">
					...
					<Row style="height: 100px">
						<Col span="24" class="ivu-b ivu-text-center"><p style="margin-top: 20%;font-size: 20px">0.05级</p></Col>
					</Row>
				</Col>
				<Col span="4" class="ivu-b ivu-text-center">
					<Row style="height: 100px">
					...
					<Row style="height: 100px">
						<Col span="24" class="ivu-b ivu-text-center"><Input class="pInput" v-model="entity.sRegulateCode"/></Col>
					</Row>
				</Col>
				<Col span="4" class="ivu-b ivu-text-center">
					<Row style="height: 100px">
					...
					<Row style="height: 100px">
						<Col span="24" class="ivu-b ivu-text-center"><Input class="pInput" v-model="endDate"/></Col>
					</Row>
				</Col>
			</Row>
			...
			<Row style="height: 200px">
				...
				<Col span="4" class="ivu-b ivu-text-center">
					...
					<Row style="height: 100px">
						<Col span="24" class="ivu-b ivu-text-center"><p style="margin-top: 10%;font-size: 20px">数字压力计<br>（10 - 280）</p></Col>
					</Row>
				</Col>
				<Col span="4" class="ivu-b ivu-text-center">
					<Row style="height: 100px">
				...
				<Col span="4" class="ivu-b ivu-text-center">
					...
					<Row style="height: 100px">
						<Col span="24" class="ivu-b ivu-text-center"><Input class="pInput" v-model="entity.sRegulateBcode"/></Col>
					</Row>
				</Col>
				<Col span="4" class="ivu-b ivu-text-center">
					<Row style="height: 100px">
...
export default {
	...
	methods: {
		...
		modalOk(){
			...
			if ( resultType == 3){
				// entityRequest('insert', 'pgRecords', this.entity,
				// 		(response)=>{
