...
public interface MyAuthService {
     ...
     * @return 符合查询条件的实体集合
     */
    List<MyAuth> getByConditions(IQueryCondition... conditions);
    /**
     * 获取符合查询条件的实体集合.
     * @param entityQuery 查询条件
     * @return 符合查询条件的结果
     */
    List<MyAuth> getByQuery(IEntityQuery entityQuery);
    /**
     * 分页获取符合查询条件的实体集合.
     * @param entityQuery 查询条件
     * @return 符合查询条件的分页结果
     */
    QueryResult<MyAuth> pageByQuery(IEntityQuery entityQuery);
