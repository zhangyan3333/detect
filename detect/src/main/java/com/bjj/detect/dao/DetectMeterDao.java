 ...
 * @author 代码生成器
 */
public interface DetectMeterDao {
    ...
    /**
     * 更新多个实体.
     * @param detectMeters 需要更新的实体集合
     */
    void updateAll(List<DetectMeter> detectMeters);

    /**
     * 插入或更新单个实体(若实体不存在，则插入实体；若实体存在,在则更新实体).
     * @param detectMeter 需要插入或更新的实体
     */
    void insertOrUpdate(DetectMeter detectMeter);
    /**
     * 插入或更新多个实体(若实体不存在，则插入实体；若实体存在,在则更新实体).
     * @param detectMeters 需要插入或更新的实体集合
     */
    void insertOrUpdateAll(List<DetectMeter> detectMeters);

    /**
     * 删除单个实体.
     * @param detectMeter 需要删除的实体
     */
    void delete(DetectMeter detectMeter);
    /**
     * 删除多个实体.
     * @param detectMeters 需要删除的实体集合
     */
    void deleteAll(List<DetectMeter> detectMeters);
    /**
     * 删除指定Id的实体.
     * @param id 需要删除的实体Id
     */
     ...
     * @return 属性匹配的实体集合
     */
    List<DetectMeter> getByProperty(String propertyName, Object value);
    /**
     * 获取指定ID的实体.
     * @param id 需要获取的实体Id
     * @return 指定ID的实体
     ...
     * @return 符合查询条件的实体集合
     */
    List<DetectMeter> getByQuery(Map<String, Object> query);
