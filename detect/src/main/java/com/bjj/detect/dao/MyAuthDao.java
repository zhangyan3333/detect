...
public interface MyAuthDao {
     ...
     */
    void insert(MyAuth myAuth);
    /**
     * 插入多个实体.
     * @param myAuths 需要插入的实体集合
     */
    void insertAll(List<MyAuth> myAuths);

    /**
     * 更新单个实体.
     * @param myAuth 需要更新的实体
     */
    void update(MyAuth myAuth);
    /**
     * 更新多个实体.
     * @param myAuths 需要更新的实体集合
     */
    void updateAll(List<MyAuth> myAuths);

    /**
     * 插入或更新单个实体(若实体不存在，则插入实体；若实体存在,在则更新实体).
     * @param myAuth 需要插入或更新的实体
     */
    void insertOrUpdate(MyAuth myAuth);
    /**
     * 插入或更新多个实体(若实体不存在，则插入实体；若实体存在,在则更新实体).
     * @param myAuths 需要插入或更新的实体集合
     */
    void insertOrUpdateAll(List<MyAuth> myAuths);

    /**
     * 删除单个实体.
     * @param myAuth 需要删除的实体
     */
    void delete(MyAuth myAuth);
    /**
     * 删除多个实体.
     * @param myAuths 需要删除的实体集合
     */
    void deleteAll(List<MyAuth> myAuths);
    /**
     * 删除指定Id的实体.
     * @param id 需要删除的实体Id
     */
     ...
     * @return 属性匹配的实体集合
     */
    List<MyAuth> getByProperty(String propertyName, Object value);
    /**
     * 获取指定ID的实体.
     * @param id 需要获取的实体Id
     * @return 指定ID的实体
     */
    MyAuth getById(long id);
    /**
     * 获取符合查询条件的实体集合.
     * @param query 查询条件集合
     * @return 符合查询条件的实体集合
