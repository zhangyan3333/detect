...
public interface DetectRecordDao {
    ...
    /**
     * 更新多个实体.
     * @param detectRecords 需要更新的实体集合
     */
    void updateAll(List<DetectRecord> detectRecords);

    /**
     * 插入或更新单个实体(若实体不存在，则插入实体；若实体存在,在则更新实体).
     * @param detectRecord 需要插入或更新的实体
     */
    void insertOrUpdate(DetectRecord detectRecord);
    /**
     * 插入或更新多个实体(若实体不存在，则插入实体；若实体存在,在则更新实体).
     * @param detectRecords 需要插入或更新的实体集合
     */
    void insertOrUpdateAll(List<DetectRecord> detectRecords);

    /**
     * 删除单个实体.
     * @param detectRecord 需要删除的实体
     */
    void delete(DetectRecord detectRecord);
    /**
     * 删除多个实体.
     * @param detectRecords 需要删除的实体集合
     */
    void deleteAll(List<DetectRecord> detectRecords);
    /**
     * 删除指定Id的实体.
     * @param id 需要删除的实体Id
     */
     ...
     * @return 属性匹配的实体集合
     */
    List<DetectRecord> getByProperty(String propertyName, Object value);
    /**
     * 获取指定ID的实体.
     * @param id 需要获取的实体Id
     * @return 指定ID的实体
     ...
     * @return 符合查询条件的实体集合
     */
    List<DetectRecord> getByQuery(Map<String, Object> query);
