...
public interface UserInfoDao {
    ...
    /**
     * 更新多个实体.
     * @param userInfoes 需要更新的实体集合
     */
    void updateAll(List<UserInfo> userInfoes);
    /**
     * 更新密码.
     * @param userInfo 需要更新的密码
     */
     ...
     * @param userInfo 需要插入或更新的实体
     */
    void insertOrUpdate(UserInfo userInfo);
    /**
     * 插入或更新多个实体(若实体不存在，则插入实体；若实体存在,在则更新实体).
     * @param userInfoes 需要插入或更新的实体集合
     */
    void insertOrUpdateAll(List<UserInfo> userInfoes);

    /**
     * 删除单个实体.
     * @param userInfo 需要删除的实体
     */
    void delete(UserInfo userInfo);
    /**
     * 删除多个实体.
     * @param userInfoes 需要删除的实体集合
     */
    void deleteAll(List<UserInfo> userInfoes);
    /**
     * 删除指定Id的实体.
     * @param id 需要删除的实体Id
     */
     ...
     * @return 属性匹配的实体集合
     */
    List<UserInfo> getByProperty(String propertyName, Object value);
    /**
     * 获取指定ID的实体.
     * @param id 需要获取的实体Id
     * @return 指定ID的实体
     ...
     * @return 符合查询条件的实体集合
     */
    List<UserInfo> getByQuery(Map<String, Object> query);
